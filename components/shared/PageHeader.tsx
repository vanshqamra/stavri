...
export const PageHeader = ({ title, description, actions }: Props) => (
  <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-amber-900 py-16 text-white">
    <Head>
    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 md:flex-row md:items-center md:justify-between">
      <div>
        <p className="text-sm uppercase tracking-[0.4em] text-amber-300">Rab Noor Pvt Ltd</p>
        <h1 className="mt-3 text-4xl font-semibold leading-tight md:text-5xl">{title}</h1>
        <p className="mt-4 text-lg text-amber-100">{description}</p>
      </div>
